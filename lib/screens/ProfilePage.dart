...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    print("imageURL: "+currentUserInfos.imageURL);
    ...
    Future uploadPic(BuildContext context) async{
      ...
      Map userMap = {
        'fullname': (username?.length > 0 ) ? username : currentUserInfos.fullName,
        'imageURI':url,
        'phone':uphone,
      };
      dbRef.set(userMap);
                        ...
                        child: ClipOval(
                          child: new SizedBox(
                            ...
                            child: (_image!=null)?Image.file(
                              _image,
                              fit: BoxFit.fill,
                            ):Image.network(currentUserInfos.imageURL,
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Visibility(
                              ...
                              child: Align(
                                alignment: Alignment.centerLeft,
                                child: Text(currentUserInfos.fullName,
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 20.0,
